...
export function AddCustomerDialog({ isOpen, onClose }: AddCustomerDialogProps) {
  ...
  const { register, handleSubmit, control, formState: { errors, isSubmitting } } = useForm<FormInput>({
    resolver: zodResolver(FormSchema),
    defaultValues: {
      customer: { status: 'active' },
      contacts: [{ name: '', is_primary: true }],
    },
  })
  ...
  return (
    <Dialog isOpen={isOpen} onClose={onClose} title="Add New Customer" size="lg">
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <Input
              ...
              label="Machine Type"
              placeholder="Roller Machine X100"
            />
            <div>
